...
urlpatterns = [
    ...
    path('profesor/<int:pk>/eliminar/', DeleteProfesor, name='delete_profesores'),
    path('profesor/<int:pk>/detalle/', DetalleProfesor, name='read_profesores'),
    path('profesores/listar/', lista_profesores, name='lista_profesores'),
    path('api/profesores/listar/', ProfesoresList),
]
